 ...
 * @return OPRT_OK on success. Others on error, please refer to tal_error_code.h
 */
OPERATE_RET tal_spi_xfer(TUYA_SPI_NUM_E port_num, VOID_T *send_buf, VOID_T *recv_buf, UINT32_T length);
 ...
 * @return OPRT_OK on success. Others on error, please refer to tal_error_code.h
 */
OPERATE_RET tal_spi_xfer_with_length(TUYA_SPI_NUM_E port_num, VOID_T *send_buf, UINT32_T send_len, VOID_T *recv_buf, UINT32_T recv_len);
 ...
 * @return TUYA_SPI_STATUS_T,please refer to tuya_cloud_types.h
 */
