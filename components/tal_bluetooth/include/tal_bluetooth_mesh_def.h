 ...
 * @brief This is tal_bluetooth_mesh_def file
 * @version 1.0
 * @date 2021-11-13
 *
...
#define TAL_MESH_PROXY_DEVICE_SVC_UUID                  (0x1828)
/* Mesh GATT Mesh Proxy Write Characteristic UUID*/
#define TAL_MESH_PROXY_WRITE_CHAR_UUID                  (0x2add)
/* Mesh GATT Mesh Proxy Notify Characteristic UUID*/
#define TAL_MESH_PROXY_NOTIFY_CHAR_UUID                 (0x2ade)

/* Mesh Device Information Service UUID */
#define TAL_MESH_DEVICE_INFO_SVC_UUID                   (0x180A)
/* Mesh Firmware Version Read Characteristic UUID*/
#define TAL_MESH_FW_VERSION_READ_CHAR_UUID              (0x2A26)
/* Mesh PnP ID Read Characteristic UUID*/
#define TAL_MESH_PNP_ID_READ_CHAR_UUID                  (0x2A50)

/* Mesh Device OTA Service UUID */
#define TAL_MESH_DEVICE_OTA_SVC_UUID                    (0x1912)
/* Mesh Device OTA Write Characteristic UUID*/
#define TAL_MESH_OTA_WRITE_CHAR_UUID                    (0x2B12)
...
typedef enum {
    ...
    TAL_MESH_STACK_DEINIT,                              /**< Deinit mesh stack event*/

    TAL_MESH_STACK_RESET,                               /**< Reset mesh stack event*/
 ...
 * @brief
 *
 * @param[in] *msg_raw: *msg_raw
 * @param[in] *net_param: *net_param
 *
...
typedef TKL_MESH_PROXY_DATA_T TAL_MESH_PROXY_DATA_T;
...
#endif /* __TAL_BLUETOOTH_MESH_DEF_H__ */
