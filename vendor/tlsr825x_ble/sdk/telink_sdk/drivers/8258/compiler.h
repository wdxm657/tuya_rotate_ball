...
#define  _attribute_bss_ret_             _attribute_session_(".retention_bss")
#define  _attribute_no_ret_data_         _attribute_session_(".no_ret_data")
#define  _attribute_no_ret_bss_          _attribute_session_(".no_ret_bss")
