...
//  round robbin foreach,   ����һ��ָ���ĵ㿪ʼ������,  h ��һ����̬������ȫ�ֱ�����Ҫ��ס��һ�ε�λ�á�h ��ʼֵ��n !!!
...
#define		MYFIFO_INIT(name,size,n)		_attribute_no_ret_bss_  u8  name##_b[size * n]={0}; _attribute_no_ret_data_   my_fifo_t name = {size,n,0,0, name##_b}
